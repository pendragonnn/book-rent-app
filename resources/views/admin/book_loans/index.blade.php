    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="mb-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <a href="{{ route('admin.book-loans.create') }}"
          class="bg-[#1B3C53] hover:bg-[#163145] text-white font-semibold py-2 px-4 rounded-lg transition">
          + Add Book Loan
        </a>
      ...
      <div class="bg-white border border-[#d2c1b6] overflow-x-auto shadow-lg sm:rounded-xl p-4">
          ...
          <tbody class="divide-y divide-gray-100">
            @foreach ($loans as $loan)
              ...
              <tr>
                ...
                <td class="px-4 py-2 gap-3 flex flex-wrap items-start justify-start">
                  <a href="{{ route('admin.book-loans.show', $loan) }}"
                    class="bg-[#1B3C53] hover:bg-[#163145] text-white px-3 py-1 rounded text-sm">View</a>
                  ...
                  @if ($loan->status === 'admin_validation')
                    <form action="{{ route('admin.book-loans.update', $loan) }}" method="POST" class="inline">
                      ...
                      <button type="submit"
                        class="bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded text-sm">Approve</button>
                    </form>
                    ...
                    <form action="{{ route('admin.book-loans.update', $loan) }}" method="POST" class="inline">
                      ...
                      <button type="submit"
                        class="bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded text-sm">Cancel</button>
                    </form>
                  @endif
      ...
      <form id="deleteForm" method="POST">
        ...
        <div class="flex justify-end space-x-2">
          <button type="button" onclick="closeDeleteModal()"
            class="g-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded">Cancel</button>
          <button type="submit"
